...
public class DynamicIntegerArray {
	...
	public void add(int v) {
		...
		int[] intArray = new int[memberIntArray.length + 1];
		...
		//   to the new array
		for(int i=0; i<memberIntArray.length; i++) {
			intArray[i] = memberIntArray[i];
		}
		
		//D. set the member array equal to the new array.
		memberIntArray = intArray;
	}
	
	//4. Complete the steps in the get method
	public int get(int location) {
		//A. Return the value of the memeber array at the location passed in
		return memberIntArray[location];
	}
